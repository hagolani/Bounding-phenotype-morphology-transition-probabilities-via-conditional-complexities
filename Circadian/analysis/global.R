...
pdf("probCom.pdf")
par(mar = c(7, 6, 4, 2) + 0.1)  # Adjusting margin
...
mtext(expression(paste(~tilde(K), "(x)")), side = 1, line = 4,cex=2.5)  # Increase the 'line' value to move the label further down
mtext(expression(paste(log[10],"P(x)")), side = 2, line = 3.5,cex=2.5)  # Increase the 'line' value to move the label further down
dev.off()
